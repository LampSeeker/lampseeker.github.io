...
# 3. [BP] BP_SpiderRobot 에 함수 생성
	...
	## 3.1. `GetBodyObservationValues`함수 생성 및 수정
			...
			- 완성된 블루프린트에서의 모습
				...
				![](https://lampseeker.github.io/api?block_id=36a5b029-aea6-8002-a5ac-dbd1d2fa0f96)
			...
			- 각 항목을 연결
				...
				![](https://lampseeker.github.io/api?block_id=36a5b029-aea6-80d7-b920-c641bef5fe80)

			- 빈 공간 우클릭해서 노드 추가(Get Actor Location) → 그 다음 `Return Value` 파란 핀에서 드래그해서(Break Vector) 추가

				![](https://lampseeker.github.io/api?block_id=36a5b029-aea6-8038-90bc-ddcc9e248d3d)
			...
			- 연결 구조
				...
				![](https://lampseeker.github.io/api?block_id=36a5b029-aea6-803b-a4c5-da2b502a4f98)
			...
			- 연결 구조
				...
				![](https://lampseeker.github.io/api?block_id=36a5b029-aea6-8072-bd4b-ecfafef57005)
			...
			- 빈 공간에서 우클릭하고 검색(Get Physics Angular Velocity in Degrees)
				...
				![](https://lampseeker.github.io/api?block_id=36a5b029-aea6-8079-acc9-f6e0149977fd)
			...
			- 완성 구조
				...
				![](https://lampseeker.github.io/api?block_id=36a5b029-aea6-8081-991a-f9a119dc9090)

		- 최종 구조

			![](https://lampseeker.github.io/api?block_id=36a5b029-aea6-809d-82fc-d581b9da7e8c)
...
# 4. [BP] BP_SpiderInteractor 작업
	...
	## 작업하기에 앞서
		...
		- BP_SpiderInteractor를 열면 노드가 깨진 상태인걸 확인할 수 있는데, 이는 C++ 재빌드를 수행해서 기존 노드가 깨진 것이다. 오른쪽 클릭을 해서 새로고침을 하자
			...
			![](https://lampseeker.github.io/api?block_id=36b5b029-aea6-8045-a075-f94b544c2ac7)
	...
	## 4.1. [BP]Gather Agent Observation 오버라이딩
		...
		![](https://lampseeker.github.io/api?block_id=36b5b029-aea6-8099-b3e0-d699b9e92e4f)
		...
		- 전에 만든 BP_SpierRobot 안에 만든 함수(GetBodyObservationValues)를 다시 보면, 이런 식으로 몸체 상태를 9개의 값으로 반환한다
			...
			![](https://lampseeker.github.io/api?block_id=36b5b029-aea6-808a-8e38-c859465eb9dc)
		...
		- `Get Agent`**/Return Value 출력핀 드래그 → **`Get Body Observation Values `노드 생성
			...
			![](https://lampseeker.github.io/api?block_id=36b5b029-aea6-80b3-8265-c0174404ee52)
	...
	## 4.2. [BP]관절 상태 읽기
		...
		- Spider Joint Controller →`Get Joint Observation Values` 호출
			...
			![](https://lampseeker.github.io/api?block_id=36b5b029-aea6-80a0-9bb4-f3ffcc24b444)
		...
		- 최종 테스트 출력 형태
			...
			![](https://lampseeker.github.io/api?block_id=36b5b029-aea6-80e0-859d-f380ca2df9f6)

		- BP가 또 초기화해서 관절 설정이 누락되었을 수도 있으니, BP_SpiderRobot→SpiderJointController의 디테일→SpiderJoint으로 가서, Joint Config Data 확인

			![](https://lampseeker.github.io/api?block_id=36b5b029-aea6-80b7-b47f-cfc3b6e11025)
	...
	## 4.3. [BP]Specify Agent Observation 오버라이딩
		...
		- 즉,
			...
			- 우리는
				...
				![](https://lampseeker.github.io/api?block_id=36b5b029-aea6-8099-b5a0-e8078e3696ff)
			...
			- 완성 구조
				...
				![](https://lampseeker.github.io/api?block_id=36b5b029-aea6-8087-8e08-c721cdebd601)
			...
			![](https://lampseeker.github.io/api?block_id=36b5b029-aea6-8082-b534-fd2a53520177)
			...
			- MakeArray/Array → Prompt to Local Value 선택 후, 로컬변수 이름 변경(BuiltObservationValues)
				...
				![](https://lampseeker.github.io/api?block_id=36b5b029-aea6-80db-bdca-f271b1dab517)
			...
			- Return Node → 디테일 → 출력에서 플로트 / 배열 선택
				...
				![](https://lampseeker.github.io/api?block_id=36b5b029-aea6-80eb-99d2-fea81341a50f)
			...
			- 최종 구조
				...
				![](https://lampseeker.github.io/api?block_id=36b5b029-aea6-80d1-a473-ed99b5e2b272)

		- 이제 실제로 로봇 블루포인트에 연결을 해서 테스트를 해보자
		- BP)SpiderRobot으로 들어가서 이렇게 노드를 연결하고 컴파일 실행 후, 로그를 확인

			![](https://lampseeker.github.io/api?block_id=36b5b029-aea6-80fe-9357-ef01343e3b6d)
	...
	## 4.4. [BP]로봇 Observation 값을 Learning Agents Observation으로 전달
		...
		- 먼저 BP_SpiderInteractor 의  Gather Agent Observation 함수로 이동
			...
			![](https://lampseeker.github.io/api?block_id=36b5b029-aea6-80d2-914c-fba4949c7d6c)
		...
		- `Gather Agent Observation` 노드에 있는 파란 핀→`**Make Continuous Observation**`노드 생성()
			...
			![](https://lampseeker.github.io/api?block_id=36b5b029-aea6-80ba-b56f-d3efb04fe3d3)
		...
		- `Get Observation Values`의 배열 출력을 `Make Continuous Observation`에 연결해서 우리가 로봇에서 뽑은 float Array 값을 Continuous Observation 형식으로 감싼다
			...
			![](https://lampseeker.github.io/api?block_id=36b5b029-aea6-808e-9f78-cead46e60f7a)
		...
		- 최종 구조
			...
			![](https://lampseeker.github.io/api?block_id=36b5b029-aea6-8024-93e3-c13300b4e35c)
