...
## 2.1. Learning Agent 세팅
	...
	### 2.1.1.Learning Agents Manager 추가
		...
		- 거미 로봇을 학습 대상으로 등록하고, 관찰값/행동값/보상/학습 실행을 관리하는 훈련 감독자를 등록해야 한다. 이를 위해 관리자 블루프린트 액터를 추가해보자(이름 : BP_SpiderTrainingManager)
			...
			![](https://lampseeker.github.io/api?block_id=3665b029-aea6-802d-b93c-f444629f8140)
		...
		- 이제 `**BP_SpiderTrainingManager**`** 안에 Learning Agents Manager 컴포넌트를 추가해보자**
			...
			![](https://lampseeker.github.io/api?block_id=3665b029-aea6-8098-ae8a-dfeb5ef559ee)
	...
	### 2.1.2. BeginPlay에서 거미 로봇 등록하기
		...
		- 더블클릭해서 이벤트  그래프로 들어가기
			...
			![](https://lampseeker.github.io/api?block_id=3665b029-aea6-80ca-b5f2-fc039d474114)
	...
	### 2.1.3. [BP]Agent를 모델에 등록
		...
		1. 매니저 컴포넌트 끌어오기→ 드래그 후 Get BP_SpiderLearningManager 선택
			...
			![](https://lampseeker.github.io/api?block_id=3665b029-aea6-80af-a643-e25f4be748a8)
		...
		1. 에이전트 매니저 → 에이전트 추가 
		 Manager 컴포넌트에서 `Add Agent`를 호출해 학습 대상으로 쓸 `UObject`를 등록
			...
			![](https://lampseeker.github.io/api?block_id=3665b029-aea6-80e3-a6ff-ce46f68ccb92)

		1. `BeginPlay`를 `Add Agent` 실행 핀에 연결
			- `BeginPlay`를 output 삼각형을  `Add Agent` 왼쪽 위의 실행 핀에 연결

				![](https://lampseeker.github.io/api?block_id=3665b029-aea6-80c2-b5df-cb0a21fd66df)

		1. `Agent`칸에 거미로봇 추가

			![](https://lampseeker.github.io/api?block_id=3665b029-aea6-806f-97f9-e487ab768908)

		1. 실행 흐름 정리
			- 결국 클래스를 찾아야 학습하게 되어야하니깐 시작→로봇 클래스 찾기→Agent 추가 이 흐름으로 수정하자

				![](https://lampseeker.github.io/api?block_id=3665b029-aea6-8026-a0e2-e061ba8cad87)
	...
	### 2.1.4. [BP]Interactor 블루프린트 만들기
		...
		- LearningAgent 폴더에 Learning Agents Interactor 블루프린트 클래스 추가
			...
			![](https://lampseeker.github.io/api?block_id=3665b029-aea6-802d-8c9d-f39660fa58d2)
