...
{{% details title="1.1. Agent 요소 소개" %}}

{{% details title="1. BP_SpiderTrainingManager" %}}
...
{{% details title="2. BP_SpiderInteractor" %}}
...
{{% details title="3. BP_SpiderTrainingEnvironment" %}}
...
{{% details title="4. BP_SpiderPolicy" %}}
...
{{% details title="5. BP_SpiderCritic" %}}
...
{{% details title="6. BP_SpiderPPOTrainer" %}}
...
![](/notion-assets/3665b029aea680bcb1def623faff58ff.png)
...
![](/notion-assets/3665b029aea680bb8cbafe35177b94b3.png)
...
![](/notion-assets/3665b029aea6802bb9b7f990baa1a22c.png)
...
![](/notion-assets/3665b029aea680089fbddb9f1f184f82.png)

1. `BeginPlay`를 `Add Agent` 실행 핀에 연결
- `BeginPlay`를 output 삼각형을  `Add Agent` 왼쪽 위의 실행 핀에 연결

![](/notion-assets/3665b029aea68087b46fe27752a6a6a5.png)

1. `Agent`칸에 거미로봇 추가

![](/notion-assets/3665b029aea680a79a61eb2a2fdf005b.png)

1. 실행 흐름 정리
- 결국 클래스를 찾아야 학습하게 되어야하니깐 시작→로봇 클래스 찾기→Agent 추가 이 흐름으로 수정하자

![](/notion-assets/3665b029aea680c4bf40d5969ce36c06.png)
...
{{% details title="2.2.2. [BP]Interactor 블루프린트 설정" %}}
...
![](/notion-assets/3665b029aea680eabedfe372cbe343f2.png)
...
{{% details title="2.2.3. [BP]Interactor Observation / Action 함수 오버라이딩" %}}
...
![](/notion-assets/3665b029aea6809faed9f43e3a89d25e.png)

{{% /details %}}


{{% details title="2.2.4. [BP]관절 제어를 위한 Action 구조 설계" %}}
...
{{% details title="2.2.5. [BP]Continuous Action 정의" %}}
...
![](/notion-assets/3665b029aea680d1b489de4634f6f30d.png)


![](/notion-assets/3665b029aea680878414d6b82e07987e.png)
...
{{% details title="2.2.6. [BP]Specify Continuous Action 핀 연결 및 값 설정" %}}

### 1. `In Action Schema` → `Specify Continuous Action.Schema`


![](/notion-assets/3675b029aea6800d9e5bc6a64f87de97.png)
...
![](/notion-assets/3675b029aea68079a87fe122f2273cee.png)
...
![](/notion-assets/3675b029aea6807eafcffdf4f4c38956.png)

{{% /details %}}


{{% details title="2.2.7. [BP] Perform Agent Action 연결 방향 정의" %}}
...
{{% details title="2.2.8. [[C++] SpiderJointControllerComponent를 전체 관절 제어 구조로 확장" %}}
...
![](/notion-assets/3675b029aea680b6b159c5e5998e34d6.png)

{{% /details %}}


{{% details title="2.2.9. BP_SpiderRobot 내부 JointConfigs 직접 설정 방식의 문제점" %}}
...
![](/notion-assets/3675b029aea680ca8d2fe6dcfcc4f0b8.png)

- 우리가 코드로 추가한 항목들 보이는지 확인

![](/notion-assets/3675b029aea68083b744c534a50eb366.png)
...
![](/notion-assets/3675b029aea68053a343c230687576b1.png)

![](/notion-assets/3675b029aea680108118fca6d0201f42.png)

- 따라서 블루포인트 안에 24개의 값을 직접 넣지 말고, 설정 에셋 하나만 참조하게 만들어서, 다시 컴파일되어도 24개의 관절 목록은 따로 분리되어 저장할 수 있어서 훨씬 안전하다.

{{% details title="FSpiderJointMotorConfig" %}}
...
{{% details title="USpiderJointControllerComponent.h" %}}
...
{{% details title="SpiderJointControllerComponent.cpp" %}}
...
{{% details title="2.2.10. DA_SpiderJointConfig 생성 및 BP_SpiderRobot 연결" %}}
...
![](/notion-assets/36a5b029aea68037806bfa754cb2b968.png)
...
![](/notion-assets/36a5b029aea6808ca152f4390a19c2f3.png)
...
{{% details title="2.2.11. [BP] Learning Agents Action[24]를 ApplyJointActions로 전달" %}}
...
![](/notion-assets/36a5b029aea6809e8c57eacd4a8fc9e5.png)
...
![](/notion-assets/36a5b029aea680a6af24f5eda65fcd18.png)

- Get Agent 노드의
- 클래스 선택 → BP_SpiderRobot
- Return Value → Spider Joint Controller

![](/notion-assets/36a5b029aea6804ba673d67c40d05ce8.png)
...
![](/notion-assets/36a5b029aea680c2b07fc84e5e9ecb6c.png)
...
![](/notion-assets/36a5b029aea680949fcdf7fe0ae61dd2.png)
...
![](/notion-assets/36a5b029aea6805abbb7eb3cb9002b32.png)
...
![](/notion-assets/36a5b029aea680a1bd8bd019effd3ca8.png)
...
![](/notion-assets/36a5b029aea6806aabcbd05e82947898.png)

- 컴파일 저장 후, 플레이

{{% details title="출력 로그 확인" %}}
