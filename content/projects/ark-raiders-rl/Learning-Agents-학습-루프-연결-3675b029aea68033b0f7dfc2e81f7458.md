...
## 2.1. `BP_SpiderTrainingManager`현재 상태 확인
	...
	### 2.1.1.`BP_SpiderTrainingManager`의 기존 BeginPlay 흐름 확인
		...
		- 열어서, 블루프린트 그래프를 확인해보면, 이런 상태다.
			...
			![](https://lampseeker.github.io/api?block_id=36a5b029-aea6-804b-8afe-e0abd4ba3014)
...
## 2.3. `BP_SpiderInteractor` 인스턴스 생성
	...
	- 이를 위해 BP_SpiderTrainingManager에  BeginPlay에서 생성한 `BP_SpiderInteractor` 인스턴스를 저장하기 위한 참조 변수를 추가해야 한다
		...
		![](https://lampseeker.github.io/api?block_id=36a5b029-aea6-80ea-b277-d048bd42e5c0)
	...
	- BeginPlay에서는 다음 노드를 추가한 후 이렇게 설정해주자
		...
		![](https://lampseeker.github.io/api?block_id=36a5b029-aea6-80b7-9fd0-d726409578b6)
...
## 2.4. `Add Listener`로 Interactor를 Manager에 등록
	...
	- `Set SpiderInteractor` 노드의 실행 핀 뒤에 `Add Listener` 노드를 추가한다. 그리고 `Add Listener`의 입력 핀을 다음과 같이 연결한다
		...
		Listener =SpiderInteractor
			...
			![](https://lampseeker.github.io/api?block_id=36a5b029-aea6-80ef-bd10-de666f1783ad)
	...
	- 이 연결의 의미는 다음과 같다.
		...
		![](https://lampseeker.github.io/api?block_id=36a5b029-aea6-8073-b0c0-f24239ad06e2)
...
## 2.5. 최종 연결
	...
	- 최종 BeginPlay 흐름은 다음과 같다
		...
		![](https://lampseeker.github.io/api?block_id=36a5b029-aea6-8044-a249-d99073d1fa8c)
