...
- Cache Notion internal images/files into `static/notion-assets` during sync and rewrite Markdown links to local `/notion-assets/...` paths for stable GitHub Pages deployment.
- Treat GitHub Issue image URLs only as optional external-image links, not as the default automated media pipeline.
